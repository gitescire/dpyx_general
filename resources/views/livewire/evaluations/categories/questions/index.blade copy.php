<div class="mb-4">
    ...
    <div x-data="data()" x-init="mounted()">
        ...
        <div>
            {{-- <form action="{{route('evaluations.categories.questions.store',[$evaluation,$categoryChoosed])}}"
            method="POST"> --}}
            {{-- @csrf --}}
            {{-- @method('POST') --}}
            <div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-12">
                                    <div class="row">
                                        ...
                                        <template x-if="hasSupplementaryQuestions(subcategory)">
                                            <div class="col-12 col-lg-3">
                                                <div
                                                    class="card-shadow-primary mb-3 widget-chart widget-chart2 text-left card">
                                                    <div class="widget-chat-wrapper-outer">
                                        ...
                                        <table class="table table-bordered m-0">
                                            ...
                                            <tbody>
                                                <template x-for="question in requiredQuestions(subcategory)"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <span x-text="question.status"></span>
                                                        </td>
                                                        <td>
                                                            ...
                                                            <template
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <template x-if="question.is_answerable">
                                                                        <textarea
                                                                            x-on:change="$wire.updateDescription(question.answer, question.answer.description)"
        ...
        <script>
            ...
            return {
                ...
                */
                ...
                hasSupplementaryQuestions(subcategory){
                    return _.filter(subcategory.questions, function(question){
                        return question.is_optional == 1
                    }).length > 0
                },
