                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <input type="confirm_password" name="confirm_password" minlength="8" class="form-control" placeholder="********" required>
                                </div>
                                <div class="col-12 mb-3">
                                    <label for="" class="text-muted text-uppercase">Teléfono</label>
                                    <input type="number" name="phone" minlength="10" class="form-control" placeholder="Teléfono">
                                </div>
                                <div class="col-12 mb-3">
