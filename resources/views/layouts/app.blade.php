                                                                                        ...
                                                                                        <h4 class="timeline-title">
                                                                                            ...
                                                                                            <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="avatar-icon">
                                                                                                        <img src="{{asset('images/avatars/2.jpg')}}"
                                                                                                            alt="">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="avatar-icon">
                                                                                                        <img src="{{asset('images/avatars/4.jpg')}}"
                                                                                                            alt="">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="avatar-icon">
                                                                                                        <img src="{{asset('images/avatars/5.jpg')}}"
                                                                                                            alt="">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="avatar-icon">
                                                                                                        <img src="{{asset('images/avatars/9.jpg')}}"
                                                                                                            alt="">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="avatar-icon">
                                                                                                        <img src="{{asset('images/avatars/7.jpg')}}"
                                                                                                            alt="">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="avatar-icon">
                                                                                                        <img src="{{asset('images/avatars/8.jpg')}}"
                                                                                                            alt="">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div
